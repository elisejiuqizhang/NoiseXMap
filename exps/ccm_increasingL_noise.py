...
if args.dataType.lower()!='era5':
    ...
    data=ERA5BivarData(csv_path=os.path.join(data_dir, 'Timeseries_Montreal.csv'), X_name=cause, Y_name=effect, Y_lag=0, scaler=None, season_rm=None, winter_start_month=12, winter_end_month=2)
    df=data.df
