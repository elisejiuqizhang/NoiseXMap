            ...
            for noiseAddType in list_noiseAddTypes: # add, mult, both
                for noiseWhen in list_noiseWhen: # in, post
                    ...
                    for filterType in list_filters:
                        ...
                        ax.legend()
                        plt.savefig(os.path.join(viz_save_dir,system, f'{ce_pair}_{noiseType}_{noiseAddType}_{noiseWhen}_{filterType}_sc1.png'))
                        plt.close()
                        ...
                        ax.set_ylabel('Converged Correlation Score')
                        ax.legend()
                        plt.savefig(os.path.join(viz_save_dir,system, f'{ce_pair}_{noiseType}_{noiseAddType}_{noiseWhen}_{filterType}_sc2.png'))
                        plt.close()
