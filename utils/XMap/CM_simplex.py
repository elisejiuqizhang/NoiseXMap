...
from .scores import partial_corr, corr
...
class CM_simplex:
    ...
    def __init__(self, df, causes, effects, tau=2, emd=8, knn=10, L=3000, method='vanilla',**kwargs):
        ...
        self.knn = knn
        self.method = method # either 'PCA' or 'vanilla'
...
class CM_rep_simplex:
    ...
    def causality(self):
        ...
        # M shape: (T_indices/num of samples, embedding_dim)
...
class PCM_rep_simplex(CM_rep_simplex):
    ...
    def causality(self):
        ...
        return sc1_error, sc2_error, ratio_error, sc1_corr, sc2_corr, ratio_corr
